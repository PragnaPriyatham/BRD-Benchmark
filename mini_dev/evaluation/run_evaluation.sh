...
predicted_sql_path='../llm/exp_result/masterbot/masterbot_predict_mini_dev_gpt_4_turbo_sqlite.json'
...
case $sql_dialect in
  "SQLite")
    diff_json_path="../llm/mini_dev_data/minidev/MINIDEV/mini_dev_sqlite_sample.jsonl"
